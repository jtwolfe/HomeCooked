...
Version **0.1.41**. Planning doc for a long flesh-out of the catalog, control
...
depth beyond `wine_cooler` + `ice_maker` + `sous_vide` + `multi_cooker`; procedure⇄thermal **offer/negotiate-as-steps**
