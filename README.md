...
| `homecooked-controller` | [`crates/homecooked-controller`](crates/homecooked-controller) | Host controller sim: IoMap + MockHal + interlocks + washer cotton / dryer cycle + lab TCP (interlock + cycle start/phase + washer CottonOptions + dryer DryOptions) ([control-system.md](docs/standard/control-system.md)) |
...
| `homecooked-bridge` | [`crates/homecooked-bridge`](crates/homecooked-bridge) | Fabric bridges: Modbus (in-memory + TCP lab) + Matter + Zigbee + BACnet mock adapters ([bridges.md](docs/standard/bridges.md)) |
