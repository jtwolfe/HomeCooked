...
- [`docs/ROADMAP.md`](docs/ROADMAP.md) — ~72% toward ~75% completeness plan, Tier-A
...
| simulator-web | [`apps/simulator-web`](apps/simulator-web) | Static HTML/JS UI: full catalog picker (Tier-A ∪ Tier-B), procedure runner, thermal plant panel, device **thermal port** chips (`water_heater` / `fridge` / `hvac` / `dishwasher` / `dryer`) |
